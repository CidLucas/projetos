...
3. Fase 3 (feita) — `monorepo/design/` criado na branch `design/fase-3`; wireframes
   migrados (`telas/blu`, `telas/brain`), DS (`design-systems/blu-original`,
   `brand-hub`); sync-brand-hub aponta para a nova fonte; previews 8899 ok. ✅
